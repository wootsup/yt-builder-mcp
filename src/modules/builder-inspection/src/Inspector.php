...
final class Inspector
{
    ...
    private const FALLBACK_CATALOG = [
        ...
        ['name' => 'grid_item', 'label' => 'Grid Item', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'panel', 'label' => 'Panel', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'switcher', 'label' => 'Switcher', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'switcher_item', 'label' => 'Switcher Item', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'tabs', 'label' => 'Tabs', 'origin' => 'builtin', 'has_children' => true],
        ...
        ['name' => 'slider', 'label' => 'Slider', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'gallery', 'label' => 'Gallery', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'lightbox', 'label' => 'Lightbox', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'modal', 'label' => 'Modal', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'social', 'label' => 'Social', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'social_item', 'label' => 'Social Item', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'button_group', 'label' => 'Button Group', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'button', 'label' => 'Button', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'button_item', 'label' => 'Button Item', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'headline', 'label' => 'Headline', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'subtitle', 'label' => 'Subtitle', 'origin' => 'builtin', 'has_children' => false],
        ...
        ['name' => 'iconnav', 'label' => 'Icon Nav', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'divider', 'label' => 'Divider', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'spacer', 'label' => 'Spacer', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'overlap', 'label' => 'Overlap', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'animation', 'label' => 'Animation', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'progress', 'label' => 'Progress', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'countdown', 'label' => 'Countdown', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'map', 'label' => 'Map', 'origin' => 'builtin', 'has_children' => true],
        ['name' => 'map_marker', 'label' => 'Map Marker', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'twitter', 'label' => 'Twitter', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'code', 'label' => 'Code', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'html', 'label' => 'HTML', 'origin' => 'builtin', 'has_children' => false],
        ['name' => 'widget', 'label' => 'Widget', 'origin' => 'builtin', 'has_children' => false],
    ];
