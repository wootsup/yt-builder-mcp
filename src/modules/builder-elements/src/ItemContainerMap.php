...
{
    /**
     * Canonical YT-Pro container → item pairing.
     *
     ...
     *
     * NB: There is NO `slider` / `slider_item` pair on YT-Pro 4.5.33 —
     * the YT slider/carousel widgets render via `slideshow`,
     * `overlay-slider`, and `panel-slider`.
     *
